/**
 * @ngdoc overview
 * @name sabzWebApp.admin.user.create
 * @description
 * The `sabzWebApp.admin.user.create` module which provides
 *
 * - {@link sabzWebApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
...
(function () {
	...
	angular
		.module('sabzWebApp.admin.user.create', [
			...
			'sabzWebApp.auth',
			'sabzWebApp.toast',
			'sabzWebApp.remoteUnique',
			'sabzWebApp.mongooseError'
		])
