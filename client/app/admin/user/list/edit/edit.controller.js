/**
 * @ngdoc controller
 * @name sabzWebApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name sabzWebApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link sabzWebApp.admin.user.list.edit.controller:UserEditController UserEditController}
