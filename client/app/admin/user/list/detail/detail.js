/**
 * @ngdoc overview
 * @name sabzWebApp.admin.user.list.detail
 * @description
 * The `sabzWebApp.admin.user.list.detail` module which provides:
 *
 * - {@link sabzWebApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires sabzWebApp.auth.user
 */
(function () {
	'use strict';
