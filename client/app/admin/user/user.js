(function () {
	...
	/**
	 * Introduce the sabzWebApp.user module
	 * and configure it.
	 *
	 * @requires ngResource
	 * @requires ui.router
	 * @requires {sabzWebApp.admin.user.list}
	 * @requires {sabzWebApp.admin.user.create}
	 */
	angular
		.module('sabzWebApp.admin.user', [
			'ngResource',
			'ui.router',
			'sabzWebApp.admin.user.list',
			'sabzWebApp.admin.user.create'
		])
